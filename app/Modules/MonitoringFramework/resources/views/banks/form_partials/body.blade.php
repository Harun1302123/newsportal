                ...
                <div class="step-app" id="step-form">
                    ...
                    <div class="step-content" style="padding-top: 40px !important;">
                        <div class="step-tab-panel" data-step="step1">
                            @include('MonitoringFramework::banks.form_partials.tab_1')
                        </div>
                        <div class="step-tab-panel" data-step="step2">
                            @include('MonitoringFramework::banks.form_partials.tab_4')
                        </div>
                        <div class="step-tab-panel" data-step="step3">
                            @include('MonitoringFramework::banks.form_partials.tab_6')
                        </div>
                        <div class="step-tab-panel" data-step="step4">
                            @include('MonitoringFramework::banks.form_partials.tab_9')
                        </div>
                        <div class="step-tab-panel" data-step="step5">
                            @include('MonitoringFramework::banks.form_partials.tab_11')
                        </div>
                        <div class="step-tab-panel" data-step="step6">
                            @include('MonitoringFramework::banks.form_partials.tab_12')
                        </div>
                        <div class="step-tab-panel" data-step="step7">
                            @include('MonitoringFramework::banks.form_partials.tab_13')
                        </div>
                        <div class="step-tab-panel" data-step="step8">
                            @include('MonitoringFramework::banks.form_partials.tab_14')
                        </div>
                        <div class="step-tab-panel" data-step="step9">
                            @include('MonitoringFramework::banks.form_partials.tab_15')
                        </div>
                        <div class="step-tab-panel" data-step="step10">
                            @include('MonitoringFramework::banks.form_partials.tab_16')
                        </div>
                        <div class="step-tab-panel" data-step="step11">
                            @include('MonitoringFramework::banks.form_partials.tab_17')
                        </div>
                    </div>
