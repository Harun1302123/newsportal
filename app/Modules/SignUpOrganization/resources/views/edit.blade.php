...
<div class="card card-outline card-primary">
    ...
    {!! Form::open([
        'route' => 'signup-organizations.update',
        'method' => 'post',
        'id' => 'form_id',
        ...
        <div class="row">
            <div class="form-group col-md-12 {{ $errors->has('organization_name_en') ? 'has-error' : '' }}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::text('organization_name_en', old('organization_name_en', $data->organization_name_en), ['class' => 'form-control required']) !!}
            ...
            <div class="form-group col-md-12 {{ $errors->has('organization_name_bn') ? 'has-error' : '' }}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::text('organization_name_bn', old('organization_name_bn', $data->organization_name_bn), ['class' => 'form-control required']) !!}
            ...
            <div class="form-group col-md-12 {{$errors->has('organization_type') ? 'has-error' : ''}}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::select('organization_type', $organization_types, old('organization_type', $data->organization_type), $attributes = ['class' => 'form-control required', 'data-rule-maxlength' => '40', 'placeholder' => 'Select Organization Type', 'id' => 'organizationType']) !!}
