        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header card-outline card-primary">
                    <h5 class="card-title"><strong>Cooperatives Data Preview</strong></h5>
                ...
                @include('MonitoringFramework::cooperatives.view_details')

                <div class="card-footer">
                    <div class="float-left">
                        <a href="{{ route('cooperatives.list') }}" class="btn btn-sm btn-default"><i class="fa fa-times"></i>
                            Close</a>
                    </div>
