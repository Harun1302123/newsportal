            ...
            <div class="row">
                ...
                <div class="form-group col-md-12  {{ $errors->has('details_en') ? 'has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            {!! Form::textarea('details_en', null, ['class' => 'form-control required details_en', 'size' => '5x3']) !!}
                ...
                <div class="form-group col-md-12  {{ $errors->has('details_bn') ? 'has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            {!! Form::textarea('details_bn', null, ['class' => 'form-control required details_bn', 'size' => '5x3']) !!}
                ...
                <div class="form-group col-md-6  {{ $errors->has('photo_category') ? 'has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('photo_category', $resource_categories, null, [
