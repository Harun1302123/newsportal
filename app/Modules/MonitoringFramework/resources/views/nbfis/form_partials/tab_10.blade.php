    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>{!! Form::number('complaints_received', old('complaints_received'), ['class' => 'form-control input-md custom-input']) !!}</td>
                    <td>{!! Form::number('complaints_resolved', old('nflpo_other_region'), ['class' => 'form-control input-md custom-input']) !!}</td>
                </tr>
            </table>
        </div>
    </div>
