                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable1_1->count())
                                    @foreach($mefBankDetailsTable1_1 as $key => $item)
                                        <tr>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable1_2->count())
                                    @foreach($mefBankDetailsTable1_2 as $key => $item)
                                        <tr>
                                            <th>{{$item->mefBankLabel->name ?? null}}</th>
                                            <td>{{$item->male_rural ?? null}}</td>
                                            <td>{{$item->male_urban ?? null}}</td>
                        ...
                        <div class="table-responsive">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item text-center font-weight-bold">1.3 Age Wise Account (Total Individual Accounts)</li>
                              </ul>
                            ...
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable1_3->count())
                                    @foreach($mefBankDetailsTable1_3 as $key => $item)
                                        <tr>
                                            <th>{{$item->mefBankLabel->name ?? null}}</th>
                                            <td>{{$item->male_rural ?? null}}</td>
                                            <td>{{$item->male_urban ?? null}}</td>
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable2_1_1)
                                <tr>
                                    <td>{{$mefBankDetailsTable2_1_1->large_loan_rural}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->large_loan_urban}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->cottage_rural}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->cottage_urban}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->micro_rural}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->micro_urban}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->small_rural}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->small_urban}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->medium_rural}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->medium_urban}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->other_rural}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->other_urban}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->total_rural}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->total_urban}}</td>
                                    <td>{{$mefBankDetailsTable2_1_1->total_total}}</td>
                                </tr>
                                @endif
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable2_1_2->count())
                                    @foreach($mefBankDetailsTable2_1_2 as $key => $item)
                                        <tr>
                                            <th>{{$item->mefBankLabel->name ?? null}}</th>
                                            <td>{{$item->male_rural ?? null}}</td>
                                            <td>{{$item->male_urban ?? null}}</td>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable2_2_1)
                                    <tr>
                                        <td>{{ $mefBankDetailsTable2_2_1->large_loan_rural??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->large_loan_urban??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->cottage_rural??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->cottage_urban??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->micro_rural??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->micro_urban??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->small_rural??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->small_urban??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->medium_rural??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->medium_urban??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->other_rural??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->other_urban??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->total_rural??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->total_urban??null }}</td>
                                        <td>{{ $mefBankDetailsTable2_2_1->total_total??null }}</td>
                                    </tr>
                                @endif
                            </table>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable2_2_2->count())
                                    @foreach($mefBankDetailsTable2_2_2 as $key => $item)
                                        <tr>
                                            <th>{{$item->mefBankLabel->name ?? null}}</th>
                                            <td>{{$item->male_rural ?? null}}</td>
                                            <td>{{$item->male_urban ?? null}}</td>
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable3_1->count())
                                    @foreach($mefBankDetailsTable3_1 as $key => $item)
                                        <tr>
                                            <th>{{$item->mefBankLabel->name ?? null}}</th>
                                            <td>{{$item->male_rural ?? null}}</td>
                                            <td>{{$item->male_urban ?? null}}</td>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable3_2->count())
                                    @foreach($mefBankDetailsTable3_2 as $key => $item)
                                        <tr>
                                            <th>{{$item->mefBankLabel->name ?? null}}</th>
                                            <td>{{$item->male_rural ?? null}}</td>
                                            <td>{{$item->male_urban ?? null}}</td>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable3_3->count())
                                    @foreach($mefBankDetailsTable3_3 as $key => $item)
                                        <tr>
                                            <th>{{$item->mefBankLabel->name ?? null}}</th>
                                            <td>{{$item->male_rural ?? null}}</td>
                                            <td>{{$item->male_urban ?? null}}</td>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                ...
                                @if ($mefBankDetailsTable4_1->count())
                                    @php
                                    $total_male_rural = 0;
                                    $total_male_urban = 0;
                                    $total_male_total = 0;
                                    ...
                                    @endphp
                                    @foreach($mefBankDetailsTable4_1 as $key => $item)
                                    @php
                  ...
                  <div class="table-responsive">
                      ...
                      <table class="table table-bordered">
                          ...
                          @if ($mefBankDetailsTable4_2->count())
                              @foreach($mefBankDetailsTable4_2 as $key => $item)
                                  <tr>
                                      <th>{{$item->mefBankLabel->name ?? null}}</th>
                  ...
                  <div class="table-responsive">
                      <table class="table table-bordered">
                          ...
                          <tr>
                              ...
                              <td class="text-center"rowspan="2" colspan="4">Total</td>
                          </tr>
                          <tr>
                          ...
                          @if ($mefBankDetailsTable5->count())
                              @foreach($mefBankDetailsTable5 as $key => $item)
                                  <tr>
                                      <th>{{$item->mefBankLabel->name ?? null}}</th>
              ...
              <div class="row">
                  ...
                  <div class="table-responsive">
                      <table class="table table-bordered">
                          ...
                          <tr>
                              <td class="text-center" colspan="6">Number of Accounts Using Internet Banking/App Based Banking</td>
                              <td class="text-center" colspan="6">Debit Card Users</td>
                          ...
                          @if ($mefBankDetailsTable6)
                            <tr>
                                <td>{{$mefBankDetailsTable6->nauib_male_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->nauib_male_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->nauib_female_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->nauib_female_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->nauib_others_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->nauib_others_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->dcu_male_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->dcu_male_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->dcu_female_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->dcu_female_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->dcu_others_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->dcu_others_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->ccu_male_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->ccu_male_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->ccu_female_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->ccu_female_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->ccu_others_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->ccu_others_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->pcu_male_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->pcu_male_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->pcu_female_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->pcu_female_urban ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->pcu_others_rural ?? null}}</td>
                                <td>{{$mefBankDetailsTable6->pcu_others_urban ?? null}}</td>
                            </tr>
                          @endif
                      </table>
                  </div>
              ...
              <div class="row">
                  ...
                  <div class="table-responsive">
                      <table class="table table-bordered">
                          ...
                          @if ($mefBankDetailsTable7)
                              <tr>
                                  <td>{{$mefBankDetailsTable7->nb_rural ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->nb_urban ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->nb_total ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->nob_rural ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->nob_urban ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->nob_total ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->nsb_rural ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->nsb_urban ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->nsb_total ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->na_rural ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->na_urban ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->na_total ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->ncdm_rural ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->ncdm_urban ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->ncdm_total ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->ncrm_rural ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->ncrm_urban ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->ncrm_total ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->npos_rural ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->npos_urban ?? null}}</td>
                                  <td>{{$mefBankDetailsTable7->npos_total ?? null}}</td>
                              </tr>
                          @endif
              ...
              <div class="row">
                  ...
                  <div class="table-responsive">
                      ...
                      <table class="table table-bordered">
                          ...
                          @if ($mefBankDetailsTable8->count())
                              @foreach($mefBankDetailsTable8 as $key => $item)
                                  <tr>
                                      <th>{{$item->mefBankLabel->name ?? null}}</th>
              ...
              <div class="row">
                  ...
                  <div class="table-responsive">
                      <table class="table table-bordered">
                          ...
                          @if ($mefBankDetailsTable9->count())
                              @foreach($mefBankDetailsTable9 as $key => $item)
                                  <tr>
                                      <th>{{$item->mefBankLabel->name ?? null}}</th>
          ...
          <div class="card-body">
              <div class="row">
                  ...
                  <div class="table-responsive">
                      ...
                      <table class="table table-bordered">
                          ...
                          @if ($mefBankDetailsTable10)
                              <tr>
                                  <td>{{$mefBankDetailsTable10->nflpo_dhaka ?? null}}</td>
                                  <td>{{$mefBankDetailsTable10->nflpo_others_region ?? null}}</td>
                                  <td>{{$mefBankDetailsTable10->nflpo_total ?? null}}</td>
                                  <td>{{$mefBankDetailsTable10->np_male ?? null}}</td>
                                  <td>{{$mefBankDetailsTable10->np_female ?? null}}</td>
                                  <td>{{$mefBankDetailsTable10->np_others ?? null}}</td>
                                  <td>{{$mefBankDetailsTable10->np_total ?? null}}</td>
            ...
            <div class="card-body">
                <div class="row">
                    <div class=" mx-auto d-block">
                        <h6 class="card-title pb-2">11. Complaints Query (During the quarter)</h6>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
                            ...
                            @if ($mefBankDetailsTable12)
                                <tr>
                                    <td>{{ $mefBankDetailsTable12->complaints_received ?? null }}</td>
                                    <td>{{ $mefBankDetailsTable12->complaints_resolved ?? null }}</td>
                                    <td>{{ $mefBankDetailsTable12->received_resolved ?? null }}</td>
                                </tr>
                            @endif
                        </table>
                    </div>
