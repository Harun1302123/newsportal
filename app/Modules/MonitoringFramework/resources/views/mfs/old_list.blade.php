    ...
    <div class="card">
        <div class="card-header card-outline card-primary">
            ...
            <div class="card-tools">
                @if ($add_permission)    
                <a href="{{ route('mfs.create') }}" type="button" class="btn btn-primary ">
                    <i class="fa fa-plus"></i>
                    Create New
                </a>
                @endif
                @if (((int)Auth::user()->user_type == 1 || Auth::user()->user_role_id == 3))
                <a href="{{ route('mfs.summary_report') }}" type="button" class="btn btn-info ">
                    <i class="fa fa-eye"></i>
                    Summary Report
                </a>
                @endif
                <a href="{{ asset('docs/Mef/MFS.pdf') }}" target="_blank" type="button" class="btn btn-success">
