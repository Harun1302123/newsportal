    ...
    <div class="table-responsive">
        ...
        <table class="table table-bordered">
            <thead>
              ...
              @if (count($mef_nbfis_details_table_1_4->toArray()))
                @foreach ($mef_nbfis_details_table_1_4 as $item)
                    <tr>
                        <th style="min-width: 200px">{{ $item->name ?? null }}</th>
                        <input type="hidden" name="mef_nbfis_label_id_1_4[]" value="{{ $item->id ?? null }}">
