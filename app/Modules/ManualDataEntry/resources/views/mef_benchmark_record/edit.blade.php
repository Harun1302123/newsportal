    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                {!! Form::open([
                    'route' => 'mef_benchmark_record.store',
                    'method' => 'post',
                    'id' => 'form_id',
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-2 mr-2 {{ $errors->has('benchmark') ? 'has-error' : '' }}">
                            {!! Form::label('benchmark', 'Select Benchmark', ['class' => 'required-star']) !!}
                            {!! Form::select('benchmark', benchmarks(), $master_data->mef_benchmark_id ?? null, [
                                'id' => 'benchmark',
                                'class' => 'form-control required',
                            ]) !!}
                            {!! $errors->first('benchmark', '<span class="text-danger">:message</span>') !!}
                        </div>
                    </div>
                    <!-- Tab panes -->
                    <div class="tab-content mt-4">
                        <div class="row">
                            <div class="form-group col-md-12  {{ $errors->has('indicator_set_a') ? 'has-error' : '' }}">
                                <div class="row">
                                    {!! Form::label('indicator_set_a', 'Indicator Set A:', ['class' => 'col-md-3 control-label required-star']) !!}
                                    <div class="col-md-6">
                                        {!! Form::number('indicator_set_a', $master_data->indicator_set_a ?? null, ['class' => 'form-control required']) !!}
                                        {!! $errors->first('indicator_set_a', '<span class="help-block">:message</span>') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-12  {{ $errors->has('without_goal_12') ? 'has-error' : '' }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        {!! Form::number('without_goal_12', $master_data->without_goal_12 ?? null, ['class' => 'form-control required']) !!}
                            ...
                            <div class="form-group col-md-12  {{ $errors->has('goal_12') ? 'has-error' : '' }}">
                                <div class="row">
                                    {!! Form::label('goal_12', 'Goal 12:', ['class' => 'col-md-3 control-label required-star']) !!}
                                    <div class="col-md-6">
                                        {!! Form::number('goal_12', $master_data->goal_12 ?? null, ['class' => 'form-control required']) !!}
