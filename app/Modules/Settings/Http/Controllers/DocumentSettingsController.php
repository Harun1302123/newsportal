...
//ob#code@start - (galib) remove unused element
//ob#code@end - (galib)
...
class DocumentSettingsController
{
    ...
    public function getDocumentList(Request $request)
    {
        ...
        if (!ACL::getAccessRight($this->aclName, 'V'))
    ...
    {
        if (!ACL::getAccessRight($this->aclName, 'A')) {
            abort('401', 'You have no access right! This incidence will be reported. Contact with system admin for more information.');
        }
    ...
    {
        if (!ACL::getAccessRight($this->aclName, 'E')) {
            abort('401', 'You have no access right! This incidence will be reported. Contact with system admin for more information.');
        }
    ...
    public function createServiceDocument()
    {
        ...
        $data['process_list'] = Services::where('status', 1)->pluck('name', 'id')->toArray();
                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="form-group col-md-12 row">
                                <label for="services_id" class="col-md-3  required-star">'.$row->label_name.': </label>
                                <div class="col-md-9">
...
//        dd($request->all());
        $getName = DocType::where('services_id', $request->services_id)->pluck('input_name')->toArray();
        ...
        try {
            ...
            $service_doc->services_id = $request->services_id;
