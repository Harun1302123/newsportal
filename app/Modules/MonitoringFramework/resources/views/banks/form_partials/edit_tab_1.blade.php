<div id="tab_1" class="tab-pane active">
    <div class="table-responsive">
        <ul class="list-group list-group-flush">
            <li class="list-group-item text-center font-weight-bold">1.1 Number of Account33</li>
        </ul>
            ...
            @if ($master_data->mefBankDetailsTable1_1->count())
                @foreach($master_data->mefBankDetailsTable1_1 as $key => $item)
                    <tr>
                        ...
                        <input type="hidden" name="mef_bank_label_id_1_1[]" value="{{ $item->mef_bank_label_id ?? null }}">
                        <input type="hidden" name="mef_bank_details_table_1_1_id[]" value="{{ $item->id ?? null }}">
    ...
    <br>
    @include('MonitoringFramework::banks.form_partials.edit_tab_2')
    <br>
    @include('MonitoringFramework::banks.form_partials.edit_tab_18')
    <br>
    @include('MonitoringFramework::banks.form_partials.edit_tab_19')
    <br>
    @include('MonitoringFramework::banks.form_partials.edit_tab_3')
