<div id="tab_1" class="tab-pane active">
    <div class="table-responsive">
        ...
        <table class="table table-bordered">
            ...
            @if (count($mef_bank_details_table_1_5->toArray()))
                @foreach ($mef_bank_details_table_1_5 as $item)
                    <tr>
                        <th style="min-width: 200px">{{ $item->name ?? null }}</th>
                        <input type="hidden" name="mef_bank_label_id_1_5[]" value="{{ $item->id ?? null }}" aria-label="mef_bank_label_id_1_5[]">
