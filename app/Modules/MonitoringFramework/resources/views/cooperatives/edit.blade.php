            ...
            <div class="card">
                <div class="card-header card-outline card-primary">
                    ...
                    <div class="float-right">
                        <a href="{{ route('cooperatives.view', ['id' => Encryption::encodeId($data->id)]) }}" class="btn btn-flat btn-info btn-sm m-1">
                            Open
                        </a>
                    </div>
                </div>
                ...
                @include('MonitoringFramework::cooperatives.form_partials.body_edit')
