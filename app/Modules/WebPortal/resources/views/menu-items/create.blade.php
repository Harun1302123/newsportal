        ...
        <div class="card-body">
            <div class="form-group {{$errors->has('parent_id') ? 'has-error' : ''}}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::select('parent_id', $menu_items, '0', ['class'=>'form-control select2 required','style' => 'width:100%', 'placeholder' => '']) !!}
            ...
            <div class="form-group {{$errors->has('name_bn') ? 'has-error' : ''}}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::text('name_bn', old('name_bn'), ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{$errors->has('ordering') ? 'has-error' : ''}}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::text('ordering', old('ordering'), ['class' => 'form-control required']) !!}
            ...
            <div class="form-group {{$errors->has('heading_en') ? 'has-error' : ''}}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::text('heading_en', old('heading_en'), ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{$errors->has('heading_bn') ? 'has-error' : ''}}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::text('heading_bn', old('heading_bn'), ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{$errors->has('content_en') ? 'has-error' : ''}}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::textarea('content_en', old('content_en'), ['placeholder' => 'write your content here...', 'class' => 'form-control details', 'size' => '5x3']) !!}
            ...
            <div class="form-group {{$errors->has('content_bn') ? 'has-error' : ''}}">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        {!! Form::textarea('content_bn', old('content_bn'), ['placeholder' => 'write your content here...', 'class' => 'form-control details', 'size' => '5x3']) !!}
