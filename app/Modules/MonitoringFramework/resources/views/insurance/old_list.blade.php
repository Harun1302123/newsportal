...
<div class="card">
    <div class="card-header card-outline card-primary">
        ...
        <div class="card-tools">
            ...
            <a href="{{ route('insurance.summary_report') }}" type="button" class="btn btn-info ">
                <i class="fa fa-eye"></i>
                Summary Report
            </a>
            @endif
            <a href="{{ asset('docs/Mef/Insurance.pdf') }}" target="_blank" type="button" class="btn btn-success">
