        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th rowspan="2">Divison</th>
                    <th rowspan="2">District</th>
                    <th class="text-centher" colspan="4">Number of Total Accounts</th>
                    <th class="text-center" colspan="4">Number of Deposit Accounts</th>
                    <th class="text-center" colspan="4">Number of Total Loan Accounts</th>
                    <th class="text-center" colspan="4">Bank/NBFI-MFI Linkage Loan Accounts</th>
                </tr>
...
<div class="card-body">
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                <tr>
                    <th class="text-center" colspan="4">Number of Account Using Internet/Mobile App Based Service
                    </th>
                ...
                <tr>
                    <td>{{ $master_data->mefMfisDetailsTable3->naui_male ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->naui_female ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->naui_others ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->naui_total ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->nbrl_male ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->nbrl_female ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->nbrl_others ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->nbrl_total ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->nbpi_male ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->nbpi_female ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->nbpi_others ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable3->nbpi_total ?? null }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>{{ $master_data->mefMfisDetailsTable4->number_of_mfis ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable4->number_of_branch ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable4->number_of_online_branch ?? null }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>{{ $master_data->mefMfisDetailsTable6->mefMfisLabel->name ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable6->nt_male ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable6->nt_female ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable6->nt_others ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable6->nt_total ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable6->at_male ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable6->at_female ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable6->at_others ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable6->at_total ?? null }}</td>
                </tr>
            </table>
        </div>
    </div>
...
<div class="card-body">
    <div class="row">
        <div class="table-responsive">
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-center font-weight-bold">7. Financial Literacy Programmes (During the
                    quarter)</li>
            </ul>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>{{ $master_data->mefMfisDetailsTable7->nflpo_dhaka ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable7->nflpo_others ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable7->nflpo_total ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable7->np_male ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable7->np_female ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable7->np_others ?? null }}</td>
                    <td>{{ $master_data->mefMfisDetailsTable7->np_total ?? null }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                @if ($master_data->mefMfisDetailsTable8)
                    <tr>
                        <td>{{ $master_data->mefMfisDetailsTable8->complaints_received ?? null }}</td>
                        <td>{{ $master_data->mefMfisDetailsTable8->complaints_resolved ?? null }}</td>
                        <td>{{ $master_data->mefMfisDetailsTable8->received_resolved ?? null }}</td>
                    </tr>
                @endif
            </table>
        </div>
