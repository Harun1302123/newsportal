<div id="tab_1" class=" tab-pane">
    <div class="table-responsive">
        ...
        <table class="table table-bordered">
            ...
            <thead>
            @if ($master_data->mefBankDetailsTable1_5->count())
                @foreach($master_data->mefBankDetailsTable1_5 as $key => $item)
                    <tr>
                        <th>{{ $item->mefBankLabel->name ?? null}}</th>
                        <input type="hidden" name="mef_bank_label_id_1_5[]" value="{{ $item->mef_bank_label_id ?? null }}">
                        <input type="hidden" name="mef_bank_details_table_1_5_id[]" value="{{ $item->id ?? null }}">
