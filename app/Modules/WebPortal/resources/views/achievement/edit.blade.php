    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12 {{ $errors->has('number_en') ? 'has-error' : '' }}">
                    <div class="row">
                        {!! Form::label('number_en', 'Number in English:', ['class' => 'col-md-2 control-label required-star']) !!}
                        <div class="col-md-10">
                            {!! Form::text('number_en', old('number_en', $data->number_en), ['class' => 'form-control required']) !!}
                            {!! $errors->first('number_en', '<span class="help-block">:message</span>') !!}
                        </div>
                    </div>
                </div>

                <div class="form-group col-md-12 {{ $errors->has('number_bn') ? 'has-error' : '' }}">
                    <div class="row">
                        {!! Form::label('number_bn', 'Number in Bangla:', ['class' => 'col-md-2 control-label required-star']) !!}
                        <div class="col-md-10">
                            {!! Form::text('number_bn', old('number_bn', $data->number_bn), ['class' => 'form-control required']) !!}
                            {!! $errors->first('number_bn', '<span class="help-block">:message</span>') !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input {{ $errors->has('photo') ? ' is-invalid' : '' }}" id="image" name="image" {{ empty(optional($data)->image) ? 'required' : '' }} value="{{ optional($data)->image }}" accept="image/jpeg, image/jpg, image/png" onchange="previewImage(this, 'show_photo', '1', '')">
        ...
        <div class="card-footer">
            ...
            <div class="float-right">
                {!! Form::button('<i class="fa fa-chevron-circle-right"></i> Save', [
                    'type' => 'submit',
