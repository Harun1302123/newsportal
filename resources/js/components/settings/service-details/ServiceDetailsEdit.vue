                ...
                <div class="col-md-9">
                    <form @submit.prevent="saveForm()" id="service_details">
                        ...
                        <div class="row form-group">
                            ...
                            <div :class="['col-md-8', allerros.services_id ? 'has-error' : '']">
                                <select v-model="servicedetail.services_id" id="fiat" name="services" class="form-control input-sm" >
                                    <option value="">Select One</option>
                                    <option v-for="option in processData" :key="option.id" :value="option.id">{{option.name}}</option>
                                </select>
                                <span v-if="allerros.services_id" :class="['text-danger']">{{ allerros.services_id[0] }}</span>
                            </div>
                        </div>
                        <div class="row form-group">
    ...
    export default {
        ...
        methods: {
            ...
            saveForm() {
                ...
                form.append('services_id',this.servicedetail.services_id);
