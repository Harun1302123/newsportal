                ...
                <div class="step-app" id="step-form">
                    ...
                    <div class="step-content" style="padding-top: 40px !important;">
                        <div class="step-tab-panel" data-step="step1">
                            @include('MonitoringFramework::mfs.form_partials.tab_1')
                        </div>
                        <div class="step-tab-panel" data-step="step2">
                            @include('MonitoringFramework::mfs.form_partials.tab_2')
                        </div>
                        <div class="step-tab-panel" data-step="step3">
                            @include('MonitoringFramework::mfs.form_partials.tab_3')
                        </div>
                        <div class="step-tab-panel" data-step="step4">
                            @include('MonitoringFramework::mfs.form_partials.tab_4')
                        </div>
                        <div class="step-tab-panel" data-step="step5">
                            @include('MonitoringFramework::mfs.form_partials.tab_5')
                        </div>
                        <div class="step-tab-panel" data-step="step6">
                            @include('MonitoringFramework::mfs.form_partials.tab_6')
                        </div>
                        <div class="step-tab-panel" data-step="step7">
                            @include('MonitoringFramework::mfs.form_partials.tab_7')
                        </div>
                    </div>
