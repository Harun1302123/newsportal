        ...
        <div class="card-body">
            ...
            <div class="tab-content">
                <div class="step-app" id="step-form">
                    @include('MonitoringFramework::cmis.form_partials.nav')
                    <div class="step-content" style="padding-top: 40px !important;">
                        <div class="step-tab-panel" data-step="step1">
                            @include('MonitoringFramework::cmis.form_partials.tab_1_edit')
                        </div>
                        <div class="step-tab-panel" data-step="step2">
                            @include('MonitoringFramework::cmis.form_partials.tab_2_edit')
                        </div>
                        <div class="step-tab-panel" data-step="step3">
                            @include('MonitoringFramework::cmis.form_partials.tab_3_edit')
                        </div>
                        <div class="step-tab-panel" data-step="step4">
                            @include('MonitoringFramework::cmis.form_partials.tab_4_edit')
                        </div>
                        <div class="step-tab-panel" data-step="step5">
                            @include('MonitoringFramework::cmis.form_partials.tab_5_edit')
                        </div>
                    </div>
