...
class StoreNationalStrategiesNFISRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
            ...
            if ($this->hasFile('attachment')) {
                $rules['attachment'] = 'required|max:30024|mimes:pdf';
            }
    ...
    public function messages(): array
    {
        return [
            ...
            'attachment.max' => 'The file may not be greater than 30 MB.',
        ];
    }
}
