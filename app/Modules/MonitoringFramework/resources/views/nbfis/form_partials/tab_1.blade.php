<div id="tab_1" class="tab-pane active">
    <div class="table-responsive">
        ...
        <table class="table table-bordered">
            ...
            @if (count($mef_nbfis_details_table_1_1->toArray()))
                @foreach ($mef_nbfis_details_table_1_1 as $item)
                    <tr>
                        <th style="min-width: 200px">{{ $item->name ?? null }}</th>
                        <input type="hidden" name="mef_nbfis_label_id_1_1[]" value="{{ $item->id ?? null }}">
    ...
    <br>
    @include('MonitoringFramework::nbfis.form_partials.tab_2')
    <br>
    @include('MonitoringFramework::nbfis.form_partials.tab_11')
    <br>
    @include('MonitoringFramework::nbfis.form_partials.tab_12')
    <br>
    @include('MonitoringFramework::nbfis.form_partials.tab_3')
