...
{
    return Area::query()->where('area_type', 1)->get();
}

function getDistricts()
{
    return Area::query()->where('area_type', 2)->get();
}

function getUpazilas()
{
    return Area::query()->where('area_type', 3)->get();
}

function getDivisionWiseDistricts($divisionId)
{
    return Area::query()->where('pare_id', $divisionId)->where('area_type', 2)->get();
}
