            ...
            <div class="row">
                <div class="form-group col-md-12  {{ $errors->has('heading_en') ? 'has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            {!! Form::text('heading_en', null, ['class' => 'form-control required']) !!}
                ...
                <div class="form-group col-md-12  {{ $errors->has('heading_bn') ? 'has-error' : '' }}">
                    <div class="row">
                        {!! Form::label('heading_bn', 'Heading in Bangla:', ['class' => 'col-md-2 control-label required-star']) !!}
                        <div class="col-md-10">
                            {!! Form::text('heading_bn', null, ['class' => 'form-control required']) !!}
                ...
                <div class="form-group col-md-12  {{ $errors->has('details_en') ? 'has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            {!! Form::textarea('details_en', null, ['class' => 'form-control required details', 'size' => '5x3']) !!}
                ...
                <div class="form-group col-md-12  {{ $errors->has('details_bn') ? 'has-error' : '' }}">
                    <div class="row">
                        {!! Form::label('details_bn', 'Details in Bangla:', ['class' => 'col-md-2 control-label required-star']) !!}
                        <div class="col-md-10">
                            {!! Form::textarea('details_bn', null, ['class' => 'form-control required details', 'size' => '5x3']) !!}
                ...
                <div class="form-group col-md-6  {{ $errors->has('event_category') ? 'has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('event_category', $event_categories, null, [
                ...
                <div class="form-group col-md-6 ">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            {!! Form::input('dateTime-local', 'event_date', null, ['class' => 'form-control']) !!}
