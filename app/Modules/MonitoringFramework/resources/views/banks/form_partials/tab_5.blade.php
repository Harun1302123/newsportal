    ...
    <div class="table-responsive pt-4">
        ...
        <thead>
            ...
            @if (count($mef_bank_details_table_2_2_2->toArray()))
                @foreach ($mef_bank_details_table_2_2_2 as $item)
                    <tr>
                        <th>{{ $item->name ?? null }}</th>
                        <input type="hidden" name="mef_bank_label_id_2_2_2[]" value="{{ $item->id ?? null }}">
