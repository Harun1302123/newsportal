        ...
        <div class="card-body">
                ...
                <div class="form-group {{ $errors->has('title_bn') ? 'has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            {!! Form::text('title_bn', old('title_bn'), ['class' => 'form-control required']) !!}
                            {!! $errors->first('title_bn', '<span class="help-block">:message</span>') !!}
                        </div>
                    </div>
                </div>

                <div class="form-group {{ $errors->has('number_en') ? 'has-error' : '' }}">
                    <div class="row">
                        {!! Form::label('number_en', 'Number in English:', ['class' => 'col-md-2 control-label required-star']) !!}
                        <div class="col-md-10">
                            {!! Form::text('number_en', old('number_en'), ['class' => 'form-control required']) !!}
                            {!! $errors->first('number_en', '<span class="help-block">:message</span>') !!}
                        </div>
                    </div>
                </div>
                <div class="form-group {{ $errors->has('number_bn') ? 'has-error' : '' }}">
                    <div class="row">
                        {!! Form::label('number_bn', 'Number in Bangla:', ['class' => 'col-md-2 control-label required-star']) !!}
                        <div class="col-md-10">
                            {!! Form::text('number_bn', old('number_bn'), ['class' => 'form-control required']) !!}
