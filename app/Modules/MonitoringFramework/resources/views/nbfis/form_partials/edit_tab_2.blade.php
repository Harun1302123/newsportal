            ...
            @if ($master_data->mefNbfisDetailsTable1_2->count())
                @foreach($master_data->mefNbfisDetailsTable1_2 as $key => $item)
                    <tr>
                        ...
                        <input type="hidden" name="mef_nbfis_label_id_1_2[]" value="{{ $item->mef_nbfis_label_id ?? null }}">
                        <input type="hidden" name="mef_nbfis_details_table_1_2_id[]" value="{{ $item->id ?? null }}">
