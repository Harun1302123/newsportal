    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <input type="hidden" name="id" value="{{\App\Libraries\Encryption::encodeId($target_data->id)}}">

                    <div class="form-group col-md-12 {{$errors->has('goal_id') ? 'has-error' : ''}}">
                        <div class="row">
                            {!! Form::label('goal_id','Goal:',['class'=>'col-md-2 required-star']) !!}
                            <div class="col-md-10">
                                {!! Form::select('goal_id', $goals, $target_data->goal_id, ['class'=>'form-control required', 'placeholder'=>'Please select goal']) !!}
                    ...
                    <div class="form-group col-md-12 {{$errors->has('goal_id') ? 'has-error' : ''}}">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                {!! Form::text('order', $target_data->order ,['class' => 'form-control required']) !!}
                    ...
                    <div class="form-group col-md-12 {{$errors->has('target_number_en') ? 'has-error' : ''}}">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                {!! Form::text('target_number_en', $target_data->target_number_en, ['class' => 'form-control required']) !!}
                    ...
                    <div class="form-group col-md-12 {{$errors->has('target_number_bn') ? 'has-error' : ''}}">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                {!! Form::text('target_number_bn', $target_data->target_number_bn, ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group col-md-12 {{$errors->has('title_en') ? 'has-error' : ''}}">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                {!! Form::text('title_en', $target_data->title_en, ['class' => 'form-control required']) !!}
                    ...
                    <div class="form-group col-md-12 {{$errors->has('title_bn') ? 'has-error' : ''}}">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                {!! Form::text('title_bn', $target_data->title_bn, ['class' => 'form-control']) !!}
