            ...
            @if ($master_data->mefNbfisDetailsTable1_3->count())
                @foreach($master_data->mefNbfisDetailsTable1_3 as $key => $item)
                    <tr>
                        ...
                        <input type="hidden" name="mef_nbfis_label_id_1_3[]" value="{{ $item->mefNbfisLabel->id ?? null }}">
                        <input type="hidden" name="mef_nbfis_details_table_1_3_id[]" value="{{ $item->id ?? null }}">
