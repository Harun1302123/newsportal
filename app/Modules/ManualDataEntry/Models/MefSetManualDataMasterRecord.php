...
class MefSetManualDataMasterRecord extends Model
{
    // protected $table = 'mef_set_manual_data_master_records';
    ...
    public function mefSetManualDataDetailsRecord(): HasMany
    {
        return $this->hasMany(MefSetManualDataDetailsRecord::class, 'master_id');
    }
...
/*
    truncate table mef_set_manual_data_master_records;
    truncate table mef_set_manual_data_details_records;
*/
