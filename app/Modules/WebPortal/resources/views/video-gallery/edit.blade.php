            ...
            <div class="row">
                ...
                <div class="form-group col-md-6  {{ $errors->has('tutorial_category') ? 'has-error' : '' }}">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('tutorial_category', $tutorial_categories, $data->tutorial_category, [
                ...
                <div class="form-group col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('video_length', $data->video_length, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-12 row">
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        <div class="custom-file">
                            <input type="file"
                                   ...
                                   name="image"
                                   {{ empty(optional($data)->image) ? 'required' : '' }} value="{{ optional($data)->image }}"
                    ...
                    <small class="form-text text-muted">
                        [<strong>File Format:</strong> *.jpg/ .jpeg/ .png, <strong>File-size:</strong> 1 MB, <strong>Dimension:</strong>
                        1280x720 Pixel]
                    </small>
