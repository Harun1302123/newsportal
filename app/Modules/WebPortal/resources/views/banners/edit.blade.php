        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="form-group col-md-12 {{$errors->has('title_en') ? 'has-error' : ''}}">
                    <div class="row">
                        {!! Form::label('title_en','Title in English:',['class'=>'col-md-2 control-label']) !!}
                        <div class="col-md-10">
                            {!! Form::text('title_en', old('title_en', $data->title_en), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-12 {{$errors->has('title_bn') ? 'has-error' : ''}}">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            {!! Form::text('title_bn', old('title_bn', $data->title_bn), ['class' => 'form-control']) !!}
                ...
                <div class="form-group col-md-12 {{$errors->has('description_en') ? 'has-error' : ''}}">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            {!! Form::textarea('description_en', old('description_en', $data->description_en), ['placeholder' => 'write your content here...', 'class' => 'form-control details', 'size' => '5x3']) !!}
                ...
                <div class="form-group col-md-12 {{$errors->has('description_bn') ? 'has-error' : ''}}">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            {!! Form::textarea('description_bn', old('description_bn', $data->description_bn), ['placeholder' => 'write your content here...', 'class' => 'form-control details', 'size' => '5x3']) !!}
