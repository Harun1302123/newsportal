    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                @if( $mef_mfs_details_table_4->count() < 2)
                    <tr>
                        <th>{{ $mef_mfs_details_table_4[0]->name }}</th>
                        <td>
                            <input type="hidden" name="mef_mfs_table4_label_id" value="24">
                        ...
                        <td>
                            {!! Form::number('vt_male_rural', old('vt_male_rural'), ['class' => 'form-control input-md custom-input']) !!}
                        </td>
                        <td>
                            {!! Form::number('vt_male_urban', old('vt_male_urban'), ['class' => 'form-control input-md custom-input']) !!}
                        </td>
                        <td>
                            {!! Form::number('vt_female_rural', old('vt_female_rural'), ['class' => 'form-control input-md custom-input']) !!}
                        </td>
                        <td>
                            {!! Form::number('vt_female_urban', old('vt_female_urban'), ['class' => 'form-control input-md custom-input']) !!}
                        </td>
                        <td>
                            {!! Form::number('vt_others_rural', old('vt_others_rural'), ['class' => 'form-control input-md custom-input']) !!}
                        </td>
                        <td>
                            {!! Form::number('vt_others_urban', old('vt_others_urban'), ['class' => 'form-control input-md custom-input']) !!}
