    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                @if ($master_data->mefCooperativesDetailsTable1->count())
                    @php
                        $total_tnm_male = 0;
                        $total_tnm_female = 0;
                        $total_tnm_others = 0;
                        ...
                        $total_nla_total = 0;
                    @endphp
                    @foreach ($master_data->mefCooperativesDetailsTable1->sortBy('division_id')->all() as $item)
                        @php
...
<div class="card-body">
    <div class="row">
        <div class="table-responsive">
            <ul class="list-group list-group-flush">
                <li class="list-group-item text-center font-weight-bold">2. Balance/Outstanding amount with Cooperative
                    Societies
                </li>
            </ul>
            <table class="table table-bordered">
                ...
                @if ($master_data->mefCooperativesDetailsTable2->count())
                    @php
                        $total_dbtm_male = 0;
                        $total_dbtm_female = 0;
                        $total_dbtm_others = 0;
                        ...
                        $total_obla_total = 0;
                    @endphp
                    @foreach ($master_data->mefCooperativesDetailsTable2->sortBy('division_id')->all() as $item1)
                        @php
    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    {{-- ob@2 this will hasOne relation data, must modify this section --}}
                    <td>{{ $master_data->mefCooperativesDetailsTable3->maui_male }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->maui_female }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->maui_others }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->maui_total }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->brlt_mfs_male }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->brlt_mfs_female }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->brlt_mfs_others }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->brlt_total }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->nbpit_mfs_male }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->nbpit_mfs_female }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->nbpit_mfs_others }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable3->nbpit_total }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    {{-- ob@3 this will hasOne relation data, must modify this section --}}
                    <td>{{ $master_data->mefCooperativesDetailsTable4->noc }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable4->nob }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable4->noob }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    {{-- ob@4 this will hasOne relation data, must modify this section --}}
                    <td>{{ $master_data->mefCooperativesDetailsTable5->nflpo_dhaka }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable5->nflpo_other_region }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable5->nflpo_total }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable5->nop_male }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable5->nop_female }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable5->nop_others }}</td>
                    <td>{{ $master_data->mefCooperativesDetailsTable5->nop_total }}</td>
    ...
    <div class="row">
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                @if ($master_data->mefCooperativesDetailsTable8)
                    <tr>
                        <td>{{ $master_data->mefCooperativesDetailsTable8->complaints_received ?? null }}</td>
                        <td>{{ $master_data->mefCooperativesDetailsTable8->complaints_resolved ?? null }}</td>
                        <td>{{ $master_data->mefCooperativesDetailsTable8->received_resolved ?? null }}</td>
                    </tr>
                @endif
            </table>
        </div>
