        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header card-outline card-primary">
                    <h5 class="card-title"><strong>Benchmark Data Preview</strong></h5>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <div class="row">
                                <label class="col-lg-2 text-left">Benchmark</label>                                
                                <div class="col-md-10">
                                    {{ $master_data->mefBenchmark->name ?? null }}
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="form-group col-md-12">
                            <div class="row">
                                <label class="col-lg-2 text-left">Indicator Set A</label>                                
                                <div class="col-md-10">
                                    {{ $master_data->indicator_set_a ?? null }}
                                </div>
                            </div>
                        </div> 
