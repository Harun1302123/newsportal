                                        ...
                                        @if ($master_data->MefIndicatorManualDataDetailsRecord->count())
                                            @foreach ($master_data->MefIndicatorManualDataDetailsRecord->sortBy('indicator_id')->all() as $item)
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="mef_indicator_data_details_id[]" value="{{ $item->id??null }}">
                                                    <input type="hidden" name="indicator_id[]" value="{{ $item->indicator_id ?? null }}">
                                                    <td>
                                                        {!! Form::number('indicator_value[]', $item->indicator_value ?? old('indicator_value[]'),
                                                        ['class' => 'required form-control input-md custom-input'])
                                                        !!}
                                                    </td>
                                                </tr>
                                            @endforeach
